...
$HFST_BIN xfst -F scripts/hfst_weighted_compile.xfscript
...
$HFST_BIN fst2fst -w -i fst/lexicon.hfst -o fst/lexicon.hfstol
...
$HFST_BIN fst2fst -w -i fst/analyser-gt-dict-norm.hfst -o fst/analyser-gt-dict-norm.hfstol
$HFST_BIN fst2fst -w -i fst/analyser-gt-dict-desc.hfst -o fst/analyser-gt-dict-desc.hfstol
$HFST_BIN fst2fst -w -i fst/generator-gt-dict-norm.hfst -o fst/generator-gt-dict-norm.hfstol
$HFST_BIN fst2fst -w -i fst/generator-gt-dict-norm-bound.hfst -o fst/generator-gt-dict-norm-bound.hfstol
